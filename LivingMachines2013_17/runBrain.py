...
#            actorPopulation.exclusiveActivate(0)
 ...
 #               time.sleep(0.001)
            ...
            currentMol = actorPopulation.recordMolecule(niche)
    ...
    print actorPopulation.moleculeNiche
    if from_file == False:
        saveGenomes(0)
  ...
  for i in range(NUM_EXPERIMENTS):
        ...
        while r1 == r2 or actorPopulation.moleculeNiche[r1] != actorPopulation.moleculeNiche[r2]:
          r2 = random.randint(0,len(actorPopulation.molecules)-1)
          #print r2
        fit1 = getFitness(r1)
        fit2 = getFitness(r2)
        ...
        if len(fit1) == len(fit2):
            gameChoice = actorPopulation.moleculeNiche[r1] #random.randint(0,len(fit1)-1)
            ...
            testNewAtoms(gameChoice)
            if from_file == False and i%100 == 0:
                saveGenomes(i)
            
def testNewAtoms(niche):
