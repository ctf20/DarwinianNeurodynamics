...
class actorPopulationClass(ALModule):
  ...
  def createSHCchain(self):
    ...
    actor1 = actorClass(name = "actor",count = 0, inputs = [10,10], outputs = None, function = "product", typeA = 1) #Species input vector and the function.
    ...
    actor2 = actorClass(name = "actor",count = 1,inputs = [189],  outputs = [6], messageInputs = [1], function = None, typeA = 3)
