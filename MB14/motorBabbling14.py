...
class MotorBabbling(object):
     ...
     def updateModels(self, index_m,index_s,mot_t,sens_t,sens_t2, motor_state_t, motor_state_t_p1):
...
"""DEVELOPMENTAL PHASE 1: EVOLVING SMP PAIRS AND POPULATING AN ARCHIEVE OF SMP PRIMITIVES"""
...
"""DEVELOPMENTAL PHASE 2: EVOLVING HIERARCHICAL SMP-GROUPS CONSISTING OF TUPLES OF
SMP-PRIMTIVES FROM THE ARCHIEVE USED TO INITIALIZE THE HIGHER ORDER UNITS """
